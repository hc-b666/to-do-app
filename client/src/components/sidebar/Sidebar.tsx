      ...
      <aside className={`${sidebarState ? "w-[350px]" : "w-0 opacity-0"}  min-h-screen flex flex-col shadow-lg duration-500 transition-all ease-in-out`}>
        <div className={`h-full flex flex-col p-6 ${sidebarState ? "opacity-100" : "opacity-0 pointer-events-none"} transition-opacity duration-500 ease-in-out`}>
          ...
          <section className="flex flex-col items-start gap-2">
            <NavLink to={"/dashboard"} className="text-muted-foreground hover:text-gray-700 py-2 w-full flex items-center gap-3 cursor-pointer duration-300">
              <Calendar className="w-6 h-6" />
              <p>Today</p>
            </NavLink>
            
            <NavLink to={"/dashboard/upcoming"} className="text-muted-foreground hover:text-gray-700 py-2 w-full flex items-center gap-3 cursor-pointer duration-300">
              <Calendar className="w-6 h-6" />
              <p>Upcoming</p>
            </NavLink>
